...
public class EditActivity extends AppCompatActivity {
    ...
    public static final String PATRONYMYC = "PATRONYMYC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getExtras() != null) {
            ...
            editPatronimyc.setText(intent.getExtras().getString(PATRONYMYC));
    ...
    public void onSaveClick(View view) {
        ...
        result.putExtra(PATRONYMYC, editPatronimyc.getText().toString());
